        ...
        this.innerHTML = `
            <footer id="footer" class="relative">
                <div class="w-full h-auto md:h-40 relative bg-gray-300 overflow-hidden">
                    <div class="w-full h-full bg-gray-400 absolute inset-0 transform md:translate-x-24 md:ml-0.5 z-0"></div>
                    <div class="max-w-screen-container mx-auto relative py-10 md:py-0 px-5 md:px-0 z-10 flex flex-wrap items-center h-full space-y-3">
